...
<div class="container">
    ...
    <a href="<?= base_url('Filiere/add') ?>" class="btn btn-success">Ajouter une filiere</a>
        <a class="btn btn-success" role="button" href="<?= base_url('comporte/add') ?>">Ajouter une matiere/filiere</a>
                ...
                <a class="btn btn-info" href="<?= base_url('Filiere') ?>">Les Filieres</a>
              <a class="btn btn-info" href="<?= base_url('Matiere') ?>">Les Matieres</a>
