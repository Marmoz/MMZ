...
<?php endforeach; ?>
            ...
            <a class="btn btn-info" role="button" href="<?= base_url('comporte/index') ?>">Voir le détail</a>
            <a class="btn btn-info" role="button" href="<?= base_url('comporte/add') ?>">Ajouter une matiere/filiere</a>
