...
class Matiere extends MY_Controller {
	...
	public function index()
	{
        ...
        $data = array(
            'metaTitle' => 'Liste des Matières | MadrassApp',
...
{   
            		$data = array(
            'metaTitle' => 'Ajouter une Matière | MadrassApp'
		);
		$this->load->view('template/header', $data);
 		...
 		if( $this->require_role('admin') )
{
		...
		if ($success) {
            ...
            $data['metaTitle'] = "Liste des Matières | MadrassApp";
		  ...
		  $this->load->view('template/footer', $data);
            ...
            $data['metaTitle'] = "Ajouter une Matière | MadrassApp";
            $this->load->view('template/header', $data);
...
{      
        ...
        $data['metaTitle'] = "Liste des matieres | MadrassApp";        
        $this->load->view('template/header', $data);
        $this->load->view('matiere/index', $data);
		$this->load->view('template/footer', $data);     
...
{ 
                ...
                $data = array(
            'metaTitle' => 'Modifier une Matière | MadrassApp',
	...
	{ 		if( $this->require_role('admin') )
{
		...
		if ($success) {
		  ...
		  $this->load->view('template/footer', $data);
            ...
            $data['metaTitle'] = "Modifier une Matière | MadrassApp";
