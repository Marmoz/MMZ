...
class Comporte extends MY_Controller {
    
    public function __construct() {
		parent:: __construct();
        $this->load->model('filiere_model');
         $this->load->model('comporte_model');
	...
	{if( $this->require_role('teacher, admin') )
{
		...
		$data = array(  'metaTitle' => 'Liste détaillée des filières | MadrassApp',
	...
	{if( $this->require_role('admin') )
{
            		...
            		$data = array(
            'metaTitle' => 'Ajouter des Matiere/filieres | MadrassApp',
...
{      
        ...
        $data['metaTitle'] = "Liste des Matieres/Filieres étudiant | MadrassApp";    
        $data['filieredetail'] = $this->comporte_model->get_all();
    ...
    public function delete($idfiliere)
	{
            		...
            		$data = array(
            'metaTitle' => 'Supprimer un filiere | MadrassApp',
...
{   
                ...
                $data = array(
            'metaTitle' => 'Modifier coeff | MadrassApp',
            'lesfilieres' => $this->filiere_model->give_all(),
            'lesmatieres' => $this->matiere_model->give_all(),
            'idFiliere' => $idFiliere,
            'idMatiere' => $idMatiere
