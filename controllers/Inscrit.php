...
{   
		...
		$data = array(
            'metaTitle' => 'Liste des inscriptions étudiants | MadrassApp',
...
{   
		...
		$data = array(
            'metaTitle' => 'Liste des inscriptions étudiants | MadrassApp',
            'inafil' => $this->etudiant_model->dialDaba2(2018)

		);
		$this->load->view('template/header', $data);
		$this->load->view('inscrit/actuel', $data);
		$this->load->view('template/footer', $data);
        }
...
{   
            		$data = array(
            'metaTitle' => 'Ajouter une inscription Etudiant | MadrassApp',
...
{   
		...
		if ($success) {
            ...
            $data['metaTitle'] = "Liste des inscriptions étudiants | MadrassApp";
            ...
            $data['metaTitle'] = "Ajouter une inscription Etudiant | MadrassApp";
...
{      
        ...
        $data['metaTitle'] = "Liste des inscriptions étudiant | MadrassApp";        
        $this->load->view('template/header', $data);
        $this->load->view('inscrit/index', $data);
		$this->load->view('template/footer', $data);  
        }
...
{   
                ...
                $data = array(
            'metaTitle' => 'Modifier une inscription | MadrassApp',
...
{   
		...
		if ($success == true) {
            ...
            $data['metaTitle'] = "Modifier une inscription Etudiant | MadrassApp";
