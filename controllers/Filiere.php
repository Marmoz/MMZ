...
{            
        ...
        $data = array(
            'metaTitle' => 'Liste des Filieres | MadrassApp',
...
{     
            		$data = array(
            'metaTitle' => 'Ajouter une Filiere | MadrassApp'
		);
		$this->load->view('template/header', $data);
...
{   
		...
		if ($success) {
            ...
            $data['metaTitle'] = "Liste des Filières | MadrassApp";
		  ...
		  $this->load->view('template/footer', $data);
            ...
            $data['metaTitle'] = "Ajouter une filière | MadrassApp";
            $this->load->view('template/header', $data);
...
{     
        ...
        $data['metaTitle'] = "Liste des filieres | MadrassApp";        
        $this->load->view('template/header', $data);
        $this->load->view('filiere/index', $data);
		$this->load->view('template/footer', $data); 
		}
...
{    
                ...
                $data = array(
            'metaTitle' => 'Modifier une Filière | MadrassApp',
...
{   
		...
		if ($success) {
		  ...
		  $this->load->view('template/footer', $data);
            ...
            $data['metaTitle'] = "Modifier une Filière | MadrassApp";
